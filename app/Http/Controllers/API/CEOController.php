...
class CEOController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $constanteValidacao = 'required|max:255';

        $validator = Validator::make($data, [
            'name' => $constanteValidacao,
            'company_name' => $constanteValidacao,
            'year' => $constanteValidacao,
            'company_headquarters' => $constanteValidacao,
